...
2. Apply customizable _lowering_ dynamics to convert erasure events into correlated Pauli errors
...
- Output is sparse per-shot, erasure/reset/check-error event data.
...
- Result is a Stim-format circuit object for analysis/decoder workflows.
